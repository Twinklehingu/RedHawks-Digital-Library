...
namespace UnitTests.Components
{
    ...
    public class ProductListTests : BunitTestContext
    {
        ...
        public void Search_Valid_ID_Exist_Should_Return_Content()
        {
            ...
            {
                if (element.Id.Equals("FilterText"))
                {
                    filterText = element;
                }
                if (element.Id != null)
        ...
        public void Clear_Valid_ID_Exist_Should_Return_Content()
        {
            ...
            var buttonList_clear = page.FindAll("Button");
            var clearFilterButton = buttonList_clear.First(m => m.OuterHtml.Contains("ClearFilter"));
